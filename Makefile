...
gen_playlists:
	protoc -I proto proto/playlists.proto --go_out=./gen/go/playlists/ --go_opt=paths=source_relative --go-grpc_out=./gen/go/playlists/ --go-grpc_opt=paths=source_relative
...
gen_auth_mock:
	mockgen -source="internal/services/auth/init.go" -destination="internal/services/auth/mocks/mockgen.go"
gen_artists_mock:
	mockgen -source="internal/services/artists/init.go" -destination="internal/services/artists/mocks/mockgen.go"
migrate_test:
