...
// Source: internal/services/auth/init.go
//
...
import (
	context "context"
	models "loudy-back/internal/domain/models"
	reflect "reflect"
...
func (m *MockUserSaver) SaveUser(ctx context.Context, email string, passwordHash []byte) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveUser", ctx, email, passwordHash)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserSaverMockRecorder) SaveUser(ctx, email, passwordHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveUser", reflect.TypeOf((*MockUserSaver)(nil).SaveUser), ctx, email, passwordHash)
}
